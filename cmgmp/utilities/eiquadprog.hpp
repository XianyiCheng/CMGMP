...
// void print_matrix(const char* s, const MatrixXd& M, const int& n){
//   std::cout << s << M << n <<std::endl;
// }

// void print_vector(const char*  s, const VectorXd& M, const int& n){
//   std::cout << s << M << n <<std::endl;
// }
 ...
 print_matrix("J", J, n);
  ...
  iq = 0;
    ...
    if (!add_constraint(R, J, d, iq, R_norm))
    {
      ...
      #ifdef TRACE_SOLVER
        std::cerr << "Error: Degenerated Constraints! Equality constraints should be linearly dependent" << std::endl;
      #endif
      return f_value;
    }
  }
